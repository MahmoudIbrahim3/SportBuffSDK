...
public class CircleProgressBar extends View {
    ...
    public void setColor(int color) {
        this.color = color;
        backgroundColor = ContextCompat.getColor(getContext(), R.color.count_down_border_color);
//        backgroundPaint.setColor(adjustAlpha(color, 0.3f));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            backgroundColor = typedArray.getInt(R.styleable.CircleProgressBar_backgroundColor, backgroundColor);
